<div>
    <div @class([ 'relative w-full' , 'flex flex-wrap items-stretch'=> $prefixLabel || $suffixLabel,
        ...
        @endif
        <select {{ $attributes->except(['class']) }} id="{{ str_slug($label) }}"
            @class([ 'block ltr:pr-10 rtl:pl-10 py-2 ltr:pl-3 rtl:pr-3 transition duration-75 shadow-sm focus:ring-1
            focus:ring-inset font-semibold
            bg-gray-50
